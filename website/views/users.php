...
<body class="bg-secondary">
    <div class="container-fluid">
        <h1 class="h1 text-white mt-4 ms-3">Users</h1>
        <button class="btn btn-dark mt-2 ms-4" data-bs-toggle="modal"data-bs-target="#addNewUserModal">+</button>
        <div class="row mt-4">
            <div class="col-sm-4">
        ...
        <div class="modal fade" id="addNewUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <div class="row text-center ps-4 pe-4" style="">
                ...
                <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon3">Branch Id</span>
                  <input type="text" class="form-control" aria-describedby="basic-addon3" id="branchId" placeholder="">
              </div>
