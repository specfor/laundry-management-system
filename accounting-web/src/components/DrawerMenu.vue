<template>
    <router-link :to="{ name: 'Dashboard' }" @click.native="$emit('onMenuItemClick')">
        <li>
            <a>Dashboard</a>
        </li>
    </router-link>
    ...
    <router-link :to="{ name: 'Tax' }" @click.native="$emit('onMenuItemClick')">
        <li>
            <a>Tax</a>
        </li>
    </router-link>
    ...
    <router-link :to="{ name: 'TaxTypes' }" @click.native="$emit('onMenuItemClick')">
        <li>
            <a>Tax Types</a>
        </li>
    </router-link>
