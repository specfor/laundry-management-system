                    ...
                    <div class="pr-3 flex flex-col">
                      <div class="border border-slate-400 rounded-md p-2 mb-2">
                        <div class="grid grid-cols-3 mb-1">
                          <div class="font-semibold text-slate-700 py-0.5">Customer</div>
                          <select
                              ...
                              name="customers" :value="fieldValues['customer']"
                              @input="event => fieldValues['customer'] = event.target.value">
                            <option class=""
                                    v-for="customer in customersInfo" :value="customer.value">{{ customer.text }}
                            </option>
                          </select>
                          <div class="font-semibold text-slate-700 py-0.5">Product</div>
                          <select
                              class="mt-1 col-span-2 border-2 border-slate-400 rounded-md hover:border-slate-700 px-3 py-0.5
                               hover:bg-slate-200 disabled:border"
...
import { sendGetRequest } from '../../js-modules/base-functions';
import { apiBaseUrl } from '../../js-modules/website-constants';
  ...
  window.updateOrderModal = (customers,orderDetails,orderType,products_, actions_, values = {}) => {
